...
void					ft_array2_insert(t_array2 *array, void *text,
							size_t index);
...
void					ft_list_iter(t_list *list,
							void (*f)(t_list_link *elem));
t_list_link				*ft_list_link_new(void const *content,
							size_t content_size);
